...
idxPruebas = range(1, 38)

for ID in IDPositivos:

    with open(os.path.join(datosDir, 'VectoresPacientesEntrenamientoExp1ID' + str(ID) + '.csv'), 'w',
              newline='') as file1:
        ...
        with open(os.path.join(datosDir, 'VectoresPacientesTestExp1ID' + str(ID) + '.csv'), 'w', newline='') as file2:
