...
indicesPruebasCorreladas = [0, 1, 2, 3, 4, 6, 7, 8, 9, 10, 12, 14, 16, 20, 22, 26, 32]
...
with open(os.path.join(datosDir, 'VectoresPacientesEntrenamientoExp3ID73.csv'), 'w', newline='') as file1:
    ...
    with open(os.path.join(datosDir, 'VectoresPacientesTestExp3ID73.csv'), 'w', newline='') as file2:
