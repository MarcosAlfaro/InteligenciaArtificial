...
indicesPruebasCorreladas = [0, 1, 2, 3, 4, 6, 7, 8, 9, 12]
...
with open(os.path.join(datosDir, 'VectoresPacientesEntrenamientoExp2ID573.csv'), 'w', newline='') as file1:
    ...
    with open(os.path.join(datosDir, 'VectoresPacientesTestExp2ID573.csv'), 'w', newline='') as file2:
