...
idxPruebas = [1, 2, 3, 4, 5, 7, 8, 9, 10, 13, 36]

for ID in IDPositivos:

    with open(os.path.join(datosDir, 'VectoresPacientesEntrenamientoExp3ID' + str(ID) + '.csv'), 'w',
              newline='') as file1:
        ...
        with open(os.path.join(datosDir, 'VectoresPacientesTestExp3ID' + str(ID) + '.csv'), 'w', newline='') as file2:
