...
idxPruebas = [1, 2, 3, 5, 9, 10]

for ID in IDPositivos:

    with open(os.path.join(datosDir, 'VectoresPacientesEntrenamientoExp4ID' + str(ID) + '.csv'), 'w',
              newline='') as file1:
        ...
        with open(os.path.join(datosDir, 'VectoresPacientesTestExp4ID' + str(ID) + '.csv'), 'w', newline='') as file2:
