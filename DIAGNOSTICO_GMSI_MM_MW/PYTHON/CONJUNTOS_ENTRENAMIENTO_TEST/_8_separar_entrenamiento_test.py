...
with open(os.path.join(datosDir, 'VectoresPacientesEntrenamientoExp1ID573.csv'), 'w', newline='') as file1:
    ...
    with open(os.path.join(datosDir, 'VectoresPacientesTestExp1ID573.csv'), 'w', newline='') as file2:
